...
@section('title', 'Laporan Pengajuan Lembur')
...
<div class="container">
    ...
    <div class="card">
        ...
        <p>
            Laporan seluruh pengajuan lembur karyawan.
        </p>
    ...
    <div class="card" style="margin-top:20px;">
        ...
        <form
            method="GET"
            action="{{ route('reports.overtime.index') }}"
        >
                ...
                @forelse($overtimeRequests as $request)
                    ...
                    <tr style="border-bottom:1px solid #ddd;">
                        ...
                        <td style="padding:12px;">
                            {{ $overtimeRequests->firstItem() + $loop->index }}
                        </td>
